                        ...
                        <form method="post">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td widht="1">:</td>
                                    <td><input class="from-control" value="<?php echo $data['nama_pelanggan']; ?>"type="text" name="nama_pelanggan"></td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td>No. Telepon</td>
                                    <td>:</td>
                                    <td><input class="from-control" type="number" step="0" value <?php echo $data['no_telepon']; ?> name="no_telepon"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
